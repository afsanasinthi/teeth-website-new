...
const Register = () => {
    ...
    const { getEmailSignUp, name, email, password, getName, getEmail, getPassword, getVerifyEmail, getUpdateProfile, error, success, setError, setSuccess, setIsLoading } = useAuth();
